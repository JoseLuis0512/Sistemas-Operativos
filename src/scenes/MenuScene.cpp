...
void MenuScene::update()
{
    ...
    Rectangle btnPC = {262, 320, 220, 60};        // - Rectángulo del botón PC.
    Rectangle btnFilosofos = {542, 320, 220, 60}; // - Rectángulo del botón Filósofos.
...
void MenuScene::draw()
{
    ...
    // Título
    // --------------------------------------------------
    texto("PROYECTO SISTEMAS OPERATIVOS", 230, 180, 32, BLACK); // - Título principal del menú.
    ...
    texto("Productor/Consumidor", 276, 338, 18, BLACK);                          // - Texto del botón.
    ...
    texto("Filosofos/Comensales", 558, 338, 18, BLACK);                                  // - Texto del botón.
    ...
    // --------------------------------------------------
    texto("David Alconero Lepe         - 1216123", 282, 580, 15, BLACK);
    texto("Jose Luis Enriquez Barillas - 1053223", 282, 605, 15, BLACK);
    texto("Anthony Hernandez Perez     - 1086223", 282, 630, 15, BLACK);
    texto("Ana Sofia Siguenza Aguilar  - 1333123", 282, 655, 15, BLACK);
}